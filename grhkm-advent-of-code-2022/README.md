...
This year, I will be attempting Advent of Code with Rust, a language I have never learned before.

I will also be taking some notes while I learn the language!
...
I feel like I am familiar enough with Rust now that taking notes is not helpful anymore for me, at least not in the way I have been taking notes above. Just some updates, I started a few Rust projects, including:

-   [rust-dfa-nfa-regex](https://github.com/grhkm21/rust-dfa-nfa-regex), converting between DFA, NFA and Regex, along with some graphics for the graphs

-   [rust-graphics](https://github.com/grhkm21/rust-graphics), messing around with Rust, wasm and graphics in general. Planning to make some visualization of _something_.

-   [@rust-lang/rust](https://github.com/rust-lang/rust)! I am looking into the compiler and see if I can contribute anywhere. Currently working on the diagnostics part of the compiler, hoping to generate better warnings and errors.
